 ...
 * @author FxA
 */
@WebServlet(name = "SpelNegatiefQuoteren", urlPatterns = {"/SpelNegatiefQuoteren"})
public class SpelNegatiefQuoteren extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Spel spel = SpelServices.getSpel(Integer.parseInt(request.getParameter("id")));
            int counter = spel.getCounter();
            counter--;
            spel.setCounter(counter);

 ...
 * @author FxA
 */
@WebServlet(name = "SpelVerwijderenController", urlPatterns = {"/SpelVerwijderenController"})
public class SpelVerwijderenController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        SpelServices.deleteSpel(Integer.parseInt(request.getParameter("id")));
